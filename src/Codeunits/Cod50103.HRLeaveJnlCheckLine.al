...
Codeunit 50103 "HR Leave Jnl.-Check Line"
{
    ...
    var
        ...
        LeaveEntries: Record 51227;
        Text004: label 'The Allocation of Leave days has been done for the period';


    procedure ValidatePostingDate(var InsuranceJnlLine: Record 51228)
    begin
    ...
    procedure RunCheck(var InsuranceJnlLine: Record 51228; var JnlLineDim: Record 51270)
    var
