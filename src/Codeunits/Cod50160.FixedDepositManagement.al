...
Codeunit 50160 FixedDepositManagement
{
    TableNo = 51435;
    ...
    var
        ...
        FDInterestCalc: Record 51448;
        FAccountType: Record 51436;
        IntRate: Decimal;
        WhichDay: Integer;
        InterestAmount: Decimal;
        FixedDepType: Record 51447;
        FDDays: Integer;
        IntBufferNo: Integer;
        StatusPermission: Record 51452;
        EAccount: Code[10];
        EAMount: Decimal;
        i: Integer;
        Tsci: Integer;
    ...
    var
        ShortMessage: Record 51471;
        Account: Record 51435;
    begin

        if Account.Get(DocNo) then begin
    ...
    procedure CalculateFDInterest(Account: Record 51435; RunDate: Date)
    begin
        ...
        if AccountTypes.Get(Account."Account Type") then begin
            if AccountTypes."Fixed Deposit" = true then begin
                ...
                if FixedDepType.Find('-') then begin
