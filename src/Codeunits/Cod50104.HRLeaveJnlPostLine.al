...
Codeunit 50104 "HR Leave Jnl.-Post Line"
{
    ...
    var
        ...
        InsCoverageLedgEntry: Record 51227;
        InsCoverageLedgEntry2: Record 51227;
        InsuranceReg: Record 51190;
        InsuranceJnlCheckLine: Codeunit "HR Leave Jnl.-Check Line";
        MakeInsCoverageLedgEntry: Codeunit "HR Make Leave Ledg. Entry";
        DimMgt: Codeunit DimensionManagement;
        NextEntryNo: Integer;
        TempJnlLineDim: Record 51270;
        TempJnlLineDim2: Record 51270;


    procedure RunWithCheck(var InsuranceJnlLine2: Record 51228; TempJnlLineDim2: Record 51270)
    begin
    ...
    procedure RunWithOutCheck(var InsuranceJnlLine2: Record 51228; TempJnlLineDim: Record 51270)
    begin
        InsuranceJnlLine.Copy(InsuranceJnlLine2);
