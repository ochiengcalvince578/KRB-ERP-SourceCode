...
Codeunit 50114 LeaveJnlManagementold
{
    ...
    procedure TemplateSelection(FormID: Integer; var InsuranceJnlLine: Record 51228; var JnlSelected: Boolean)
    var
        InsuranceJnlTempl: Record 51187;
    begin
        JnlSelected := true;
    ...
    procedure TemplateSelectionFromBatch(var InsuranceJnlBatch: Record 51188)
    var
        InsuranceJnlLine: Record 51228;
        InsuranceJnlTempl: Record 51187;
        JnlSelected: Boolean;
    begin
        OpenFromBatch := true;
    ...
    procedure OpenJournal(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51228)
    begin
    ...
    procedure OpenJnlBatch(var InsuranceJnlBatch: Record 51188)
    var
        InsuranceJnlTemplate: Record 51187;
        InsuranceJnlLine: Record 51228;
        JnlSelected: Boolean;
    begin
    ...
    procedure CheckName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51228)
    var
        InsuranceJnlBatch: Record 51188;
    begin
        InsuranceJnlBatch.Get(InsuranceJnlLine.GetRangemax("Journal Template Name"), CurrentJnlBatchName);
    end;


    procedure SetName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51228)
    begin
        InsuranceJnlLine.FilterGroup := 2;
        InsuranceJnlLine.SetRange("Journal Batch Name", CurrentJnlBatchName);
        InsuranceJnlLine.FilterGroup := 0;
    ...
    procedure LookupName(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51228): Boolean
    var
        InsuranceJnlBatch: Record 51188;
    begin
        Commit;
    ...
    procedure GetDescriptions(InsuranceJnlLine: Record 51228; var InsuranceDescription: Text[30]; var FADescription: Text[30])
    var
        Insurance: Record 51183;
        FA: Record 51160;
    begin
