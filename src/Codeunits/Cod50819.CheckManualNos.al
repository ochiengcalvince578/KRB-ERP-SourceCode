...
Codeunit 50819 "Check Manual Nos"
{
    ...
    begin
        ...
        if SalesCrMemo.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if SalesReturn.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if PostedWhseShpmtHeader.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if WhsePostedRcptHeader.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if TransferReceipt.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
        ...
        if TransferShipment.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if PurchInv.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if PurchInvHeader.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
    ...
    begin
        ...
        if RetOrder.Count > 0 then begin
            Used := true;
        end
        else begin
            Used := false;
