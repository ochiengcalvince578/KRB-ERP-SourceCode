...
Codeunit 50112 "HR Make Leave Ledg. Entry"
{
    ...
    procedure CopyFromJnlLine(var InsCoverageLedgEntry: Record 51227; var InsuranceJnlLine: Record 51228)
    begin
    ...
    procedure CopyFromInsuranceCard(var InsCoverageLedgEntry: Record 51227; var Insurance: Record 51183)
    begin
        /*WITH InsCoverageLedgEntry DO BEGIN
