...
Codeunit 50017 "Process Bank Acc. Rec Lines-2"
{
    ...
    local procedure CreateBankAccRecLineTemplate(var BankAccReconLine: Record 51092; BankAccRecon: Record "Bank Acc. Reconciliation"; PostExch: Record "Data Exch.")
    begin
