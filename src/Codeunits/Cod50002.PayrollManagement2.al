...
Codeunit 50002 "Payroll Management 2"
{
    ...
    var
        ...
        PayrollPostingGroup: Record 51324;
        PayrollGenSetup: Record 51334;
        EmployeeTransactions: Record 51319;
        EmpTotalAllowances: Decimal;
        "EmpTotalAllowances(LCY)": Decimal;
        PayrollTransactions: Record 51318;
    ...
    var
        MonthlyTransactions: Record 51320;
        PayrollEmployee: Record 51317;
    begin
    ...
    var
        EmployerDeductions: Record 51327;
    begin
        if currentAmount = 0 then exit;
    ...
    var
        "Payroll Employer Ded": Record 51327;
    begin
