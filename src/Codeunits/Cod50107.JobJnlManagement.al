...
Codeunit 50107 "Job-JnlManagement"
{
    ...
    var
        ...
        LastJobJnlLine: Record 51269;
        OpenFromBatch: Boolean;


    procedure TemplateSelection(FormID: Integer; RecurringJnl: Boolean; var JobJnlLine: Record 51269; var JnlSelected: Boolean)
    var
        JobJnlTemplate: Record 51274;
    begin
        JnlSelected := true;
    ...
    procedure TemplateSelectionFromBatch(var JobJnlBatch: Record 51275)
    var
        JobJnlLine: Record 51269;
        JobJnlTemplate: Record 51274;
        JnlSelected: Boolean;
    begin
        OpenFromBatch := true;
    ...
    procedure OpenJnl(var CurrentJnlBatchName: Code[10]; var JobJnlLine: Record 51269)
    begin
    ...
    procedure OpenJnlBatch(var JobJnlBatch: Record 51275)
    var
        JobJnlTemplate: Record 51274;
        JobJnlLine: Record 51269;
        JobJnlBatch2: Record 51275;
        JnlSelected: Boolean;
    begin
    ...
    procedure GetNames(var JobJnlLine: Record 51269; var JobDescription: Text[50]; var AccName: Text[50])
    var
        Job: Record 51271;
        Res: Record Resource;
        Item: Record Item;
