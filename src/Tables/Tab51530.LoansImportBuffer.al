...
Table 51530 "Loans Import Buffer"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = ' ,College / KRBnic,No Formal Education,Primary,Secondary,University';
            OptionMembers = " ","College / KRBnic","No Formal Education",Primary,Secondary,University;
        }
